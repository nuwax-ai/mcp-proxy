...
```json
{
    ...
    "message": "操作成功",
    "data": {
        "upload_url": "https://YOUR_OSS_BUCKET.oss-rg-china-mainland.aliyuncs.com/YOUR_PATH/YOUR_FILE.md?Expires=EXPIRES_TIMESTAMP&OSSAccessKeyId=YOUR_ACCESS_KEY_ID&Signature=YOUR_SIGNATURE",
...
```bash
curl -X PUT \
  "https://YOUR_OSS_BUCKET.oss-rg-china-mainland.aliyuncs.com/YOUR_PATH/YOUR_FILE.md?Expires=EXPIRES_TIMESTAMP&OSSAccessKeyId=YOUR_ACCESS_KEY_ID&Signature=YOUR_SIGNATURE" \
...
const uploadUrl = "https://YOUR_OSS_BUCKET.oss-rg-china-mainland.aliyuncs.com/YOUR_PATH/YOUR_FILE.md?Expires=EXPIRES_TIMESTAMP&OSSAccessKeyId=YOUR_ACCESS_KEY_ID&Signature=YOUR_SIGNATURE";
