...
use crate::proxy::{
    ProxyHandler, ToolFilter, McpClientConfig, SseClientConnection,
};
    ...
    loop {
        ...
        match connect_result {
            ...
            Err(e) => {
                ...
                tracing::error!("连接失败 [{}]: {} (耗时: {:?})", error_type, summarize_error(&e), connect_duration);
